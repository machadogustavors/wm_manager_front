    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-200 to-white px-4 w-full">
      <div className="w-full max-w-xl flex flex-col md:flex-row bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
          <h1 className="text-2xl md:text-3xl font-extrabold text-indigo-700 mb-6 text-center">Confirmação de Conta</h1>
          ...
          <div className="w-full flex flex-col items-center gap-2 mt-8">
            <Link to="/login" className="font-semibold text-indigo-600 hover:text-indigo-500 text-base transition">
              Voltar para login
            </Link>
          </div>
        </div>
